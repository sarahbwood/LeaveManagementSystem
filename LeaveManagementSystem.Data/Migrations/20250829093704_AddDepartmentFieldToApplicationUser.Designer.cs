...
namespace LeaveManagementSystem.Web.Migrations
{
    ...
    [Migration("20250829093704_AddDepartmentFieldToApplicationUser")]
    partial class AddDepartmentFieldToApplicationUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeaveManagementSystem.Data.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "fead2f6c-915a-4ba5-bc59-066c40e0b53a",
                            ...
                            SecurityStamp = "220fa490-3e39-45fd-b6b6-9d8aaacab05e",
            ...
            modelBuilder.Entity("LeaveManagementSystem.Data.Department", b =>
                {
                    b.HasOne("LeaveManagementSystem.Data.ApplicationUser", "DepartmentManager")
                        .WithOne("Department")
                        .HasForeignKey("LeaveManagementSystem.Data.Department", "DepartmentManagerId")
